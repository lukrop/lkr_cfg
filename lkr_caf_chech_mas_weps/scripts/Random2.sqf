...
_rnd1 = floor random 4;
	...
	_this setObjectTextureGlobal [0, ["\caf_chech_t\tex\ig_che_2_1_co.paa",
	"\caf_chech_t\tex\ig_che_2_2_co.paa","\caf_chech_t\tex\ig_che_2_3_co.paa",
	"\caf_chech_t\tex\ig_che_2_4_co.paa"] select _rnd1];
