...
switch (_type) do {
	case 0: {
		_texArray = ["\caf_chech_t\tex\che_3_1_co.paa",
			"\caf_chech_t\tex\che_3_2_co.paa"];
	};
	case 1: {
		_texArray = ["\caf_chech_t\tex\ig_che_1_1_co.paa",
			"\caf_chech_t\tex\ig_che_1_2_co.paa"];
	};
	case 2: {
		_texArray = ["\caf_chech_t\tex\ig_che_2_1_co.paa",
			"\caf_chech_t\tex\ig_che_2_2_co.paa",
			"\caf_chech_t\tex\ig_che_2_3_co.paa",
			"\caf_chech_t\tex\ig_che_2_4_co.paa"];
	};
};
...
removeVest _unit;
// choose random vest
_vest = ["V_TacVest_camo", "V_TacVest_oli",
	"V_TacVest_khk", "V_TacVest_brn",
	"V_TacVest_blk", "V_Chestrig_oli",
	"V_Chestrig_blk", "V_Chestrig_khk"] call BIS_fnc_selectRandom;
// add vest to unit
_unit addVest _vest;
...
_hat = ["H_caf_ag_fur",
	"H_caf_ag_fur2", "H_caf_ag_beanie",
	"H_caf_ag_boonie_01", "H_caf_ag_boonie_02",
	"H_Shemag_olive", "H_Bandanna_camo",
	"H_Bandanna_cbr", "H_Bandanna_sgg",
...
_backpack = [ "B_TacticalPack_oli", "B_TacticalPack_blk",
